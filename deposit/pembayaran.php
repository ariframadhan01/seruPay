...
if(!$_POSTNominal) {
    ...
    if(isset($_POST['deposit'])) {
        ...
        if($result_csrf == false) {
            ...
            $berhasil = false;
            if(stristr($post_method,'-va') || in_array($post_method, ['qrisc', 'alfamart', 'alfamidi'])) {
                ...
                if(isset($try['success'])) {
                    if($try['success'] == true) {
                        $berhasil = true;
                        $post_note =  $post_method == 'qrisc' ? $try['data']['qr_url'] : $try['data']['pay_code'];
...
*NB* : Jika Tidak Ada Tombol Konfirmasi Silahkan Tunggu Sampai Saldo Mu Masuk.';
                    ...
                    $post_method == 'qrisc' ? $WATL->sendPicture($data_user['phone'], $textWa, $post_note, 'png') : $WATL->sendMessage($data_user['phone'], $textWa);
