        ...
        <div class="section">
            ...
            <div class="card rgs-info-deposit mt-2 mb-<?= (in_array($metode['type'], ['emoney', 'bank']) && $rows['method'] !== 'qrisc') ? '2' : '5' ?>">
                <div class="card-body">
                    ...
                    <? elseif(in_array($rows['method'], ['alfamart', 'alfamidi'])) : ?>
            ...
            <div class="form-button-group bg-primary">
                <a href="<?= base_url('deposit/invoice/'.$rows['rid']) ?>" class="btn rounded shadowed btn-block btn-lg">Selesai</a>
            </div>
