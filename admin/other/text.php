...
if(isset($_POST['submit'])) {
    ...
    if($result_csrf == false) {
        ...
        if($up == TRUE) {
            $_SESSION['result'] = ['type' => true,'message' => 'Text successfully changed.'];
        } else {
                        ...
                        <form method="POST">
                            <div class="iq-card-body">
                                ...
                                <div class="form-group">
                                    <label>Text</label>
                                    <textarea class="form-control" name="text1"><?= conf('text-marquee',1) ?></textarea>
                                </div>
                            </div>
