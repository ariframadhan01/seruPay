                            ...
                            <div class="in">
                                <div class="form-group basic">
                                    <div class="input-wrapper">
                                        ...
                                        <input type="text" class="form-control" id="displayname" placeholder="Klik Disini Untuk Cek" readonly>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="section rgs-list-layanan">
                            ...
                            <div class="row rgs-show">
                                ...
                                while($row = $search->fetch_assoc()) {
                                    if($row['status'] == 'empty') {
                                        $class = ' rgs-layanan-gangguan';
                                        $text = '<span class="text-danger">*Sedang gangguan</span>';
                                    } else {
                                        $class = '';
                                        $text = 'Rp '.currency(price($data_user['level'],$row['price'],$row['provider']));
                                    }
                                ?>
                                <div class="col-6 mb-2<?= $class ?>">
                                    <a href="javascript:;" onclick="ConfirmModal('<?= base_url('confirm-prepaid/'.$row['code'].'/') ?>')">
                                        <div class="card">
                                            <div class="card-body">
                                                <h4><?= $row['name'] ?></h4>
                                            </div>
                                            <div class="card-footer rgs-layanan-pulsa">
                                                <?= $text ?>
                                            </div>
                                        </div>
                                    </a>    
