        ...
        <div class="section full mb-2">
            <div class="wide-block pb-1 pt-1">
                ...
                <ul class="listview image-listview no-line no-space flush">
                    <li>
                        <div class="item">
                            <img src="<?= assets('mobile/img/home/pulsa-transfer-1.png') ?>" width="44px" class="image" id="RGSLogo">
                            <div class="in">
                                <div class="form-group basic">
                                    <div class="input-wrapper">
                                        <label class="label">Nomor Tujuan</label>
                                        <input type="number" class="form-control" placeholder="081210110328" name="data" id="data">
                                        <i class="clear-input">
